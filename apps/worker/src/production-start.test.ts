...
describe("built worker production artifact", () => {
  it.each([
    ...
    ["packages/document-engine/package.json", ".", "./src/index.ts", "./dist/index.js"],
    ["packages/storage/package.json", ".", "./src/index.ts", "./dist/index.js"],
    ["packages/api-contract/package.json", "./jobs", "./src/jobs/index.ts", "./dist/jobs/index.js"],
  ])(
