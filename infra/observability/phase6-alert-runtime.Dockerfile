...
WORKDIR /app
COPY --chown=node:node phase6-alert-runtime.ts phase6-alert-receiver.ts ./
COPY --chown=node:node phase6-alert-rules.yml phase6-alert-router.yml phase6-alert-evaluator.yml ./
