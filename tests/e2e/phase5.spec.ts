...
const SHARE_TOKEN = "phase5ReadOnlyToken_abcdefghijklmnopqrstuvwxyz";
...
test.describe("Phase 5 browser acceptance adapter", () => {
  test("drives upload, search, import/export, share, revoke, and anonymous 404", async ({
    ...
    await transfer.getByRole("button", { name: "Close Phase 5 tools" }).click();
