...
export const BROWSER_MATRIX_PRODUCER = "release-browserstack" as const;
...
export interface BrowserCapabilities {
  ...
  readonly "bstack:options": {
    ...
    readonly buildName: "${RELEASE_BROWSERSTACK_BUILD}";
    readonly buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}";
  };
}
...
export const EXPECTED_BROWSER_TARGETS = [
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        sessionName: "release-chrome-latest",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
  },
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        osVersion: "11",
        projectName: "GlyphQuire",
        sessionName: "release-chrome-latest-1",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
  },
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        osVersion: "11",
        projectName: "GlyphQuire",
        sessionName: "release-firefox-latest",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
  },
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        osVersion: "11",
        projectName: "GlyphQuire",
        sessionName: "release-firefox-latest-1",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
  },
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        osVersion: "11",
        projectName: "GlyphQuire",
        sessionName: "release-edge-latest",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
  },
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        osVersion: "11",
        projectName: "GlyphQuire",
        sessionName: "release-edge-latest-1",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
  },
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        osVersion: "Sequoia",
        projectName: "GlyphQuire",
        sessionName: "release-safari-latest",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
  },
  {
    ...
    capabilities: {
      ...
      "bstack:options": {
        ...
        osVersion: "Sonoma",
        projectName: "GlyphQuire",
        sessionName: "release-safari-latest-1",
        buildName: "${RELEASE_BROWSERSTACK_BUILD}",
        buildIdentifier: "${RELEASE_BROWSERSTACK_BUILD}",
      },
    },
...
function safeBuildName(env: NodeJS.ProcessEnv): string {
  const requested = env.RELEASE_BROWSERSTACK_BUILD ?? "release";
  ...
  return new Promise((resolveRun) => {
    const child = spawn(
      ...
      ],
      {
        ...
        env: {
          ...env,
          RELEASE_BROWSERSTACK_TARGET: target.id,
          RELEASE_BROWSERSTACK_BUILD: safeBuildName(env),
          RELEASE_BASE_URL: options.baseUrl ?? env.RELEASE_BASE_URL,
        },
...
export async function runBrowserStackMatrix(
  ...
  if (!options.baseUrl && !env.RELEASE_BASE_URL) {
    const evidence = createBlockedBrowserMatrixEvidence("release base URL is unavailable");
    await writeEvidence(options.evidencePath, evidence);
    return { evidence, exitCode: 2 };
  }
...
async function main(): Promise<void> {
  ...
  const result = await runBrowserStackMatrix({
    sdkConfigPath: resolve(root, cli.sdkConfigPath ?? "configs/release-browserstack.yml"),
    matrixPath: resolve(root, cli.matrixPath ?? "configs/release-browser-matrix.json"),
    specPath: resolve(root, cli.specPath ?? "tests/e2e/release-browser-matrix.spec.ts"),
    evidencePath: resolve(root, cli.evidencePath ?? "docs/evidence/release/browser-matrix.json"),
  });
  if (result.exitCode === 2) {
    process.stdout.write(
      `SKIPPED_EXTERNAL: ${result.evidence.blockingReason ?? "external evidence is unavailable"}\n`,
    );
  } else {
    process.stdout.write(`RELEASE_BROWSERSTACK_${result.evidence.status.toUpperCase()}\n`);
  }
