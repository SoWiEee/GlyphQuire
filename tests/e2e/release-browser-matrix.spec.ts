...
} from "./release-browserstack.js";

const repositoryRoot = resolve(import.meta.dirname, "../..");
const matrixPath = resolve(repositoryRoot, "configs/release-browser-matrix.json");
const evidencePath = resolve(repositoryRoot, "docs/evidence/release/browser-matrix.json");
const schemaPath = resolve(repositoryRoot, "docs/evidence/release/browser-matrix.schema.json");
...
test.describe("Release browser matrix contract", () => {
