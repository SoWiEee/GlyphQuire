# Share-Link Deployment and Incident Runbook
...
1. Take and verify the pre-deployment backup required by the destructive-change policy.
...
```bash
pnpm --filter @glyphquire/database test -- 'src/migrations/*share-links.integration.test.ts'
